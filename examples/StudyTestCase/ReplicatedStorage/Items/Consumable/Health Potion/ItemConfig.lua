return {
	-- General
	Level = 5,
	IconId = 81282291743148, -- Leave as 'nil' for no icon (show text)
	
	Cost = {"Statistic", "Gold", 80}, -- Cost & Sell can either be nil (can't be bought / sold)
	Sell = {"Statistic", "Gold", 40}, -- Same as above, but if Sell is nil, but Cost isn't, then Sell is automatically 50% the Cost price
