...
local Backpack = MainGui:WaitForChild("Backpack")
local Buttons = MainGui:WaitForChild("Buttons")
local Settings = MainGui:WaitForChild("Settings")
local PlayerList = MainGui:WaitForChild("PlayerList")
local Buttons = MainGui:WaitForChild("Buttons")
local StatsFrame = MainGui:WaitForChild("StatsFrame")
local ServerNotify = MainGui:WaitForChild("ServerNotify")
local Interact = MainGui:WaitForChild("Interact")
local OnInteract = MainGui:WaitForChild("OnInteract")
--Backpack Materials
local InfoFrame = Backpack:WaitForChild("InfoFrame")
local InfoFrame_Accessory = InfoFrame:WaitForChild("Accessory")
local InfoFrame_MainWeaponFrame = InfoFrame:WaitForChild("Item")
local InfoFrame_StatsFrame = InfoFrame:WaitForChild("StatsFrame")
local InfoFrame_ButtonBar = InfoFrame:WaitForChild("ButtonBar")
local InfoFrame_StatsFrame_NameTag = InfoFrame_StatsFrame:WaitForChild("ScrollingFrame"):WaitForChild("0"):WaitForChild("NameTag")
local InfoFrame_ButtonBar_Equipments = InfoFrame_ButtonBar:WaitForChild("Equipment"):WaitForChild("Button")
local InfoFrame_ButtonBar_Accessory = InfoFrame_ButtonBar:WaitForChild("Accessory"):WaitForChild("Button")
local InfoFrame_ButtonBar_Stats = InfoFrame_ButtonBar:WaitForChild("Stats"):WaitForChild("Button")
local InfoFrame_ButtonBar_Stats_Show = InfoFrame_StatsFrame:WaitForChild("ButtonBar"):WaitForChild("Mode"):WaitForChild("Button") 
local InfoFrame_ButtonBar_Stats_Mode = InfoFrame_StatsFrame:WaitForChild("ButtonBar"):WaitForChild("Advanced"):WaitForChild("Button") 
--Interact
local SelectedItem
...
local CurrentInv 
local Interact_Name =  Interact:WaitForChild("Name")
local Interact_Stats =  Interact:WaitForChild("Stats")
local AdvInteractOption = false
local SelectedString
--OnInteract
local OnInteract_Frame = OnInteract:WaitForChild("Frame")
--Inventory
local Inventory = Backpack:WaitForChild("Inventory")
local Inventory_Item = Inventory:WaitForChild("ItemInventory")
local Inventory_Consumable = Inventory:WaitForChild("ConsumableInventory")
local Inventory_Material = Inventory:WaitForChild("MaterialInventory")
local Inventory_Money = Inventory:WaitForChild("MoneyFrame")
local Inventory_ButtonBar = Inventory:WaitForChild("ButtonBar")
local Inventory_ButtonBar_Equipment = Inventory_ButtonBar:WaitForChild("Item"):WaitForChild("TextButton")
local Inventory_ButtonBar_Consumables = Inventory_ButtonBar:WaitForChild("Consumable"):WaitForChild("TextButton")
local Inventory_ButtonBar_Materials = Inventory_ButtonBar:WaitForChild("Material"):WaitForChild("TextButton")
local Inventory_ButtonBar_Close = Inventory_ButtonBar:WaitForChild("Close"):WaitForChild("TextButton")
--PlayerList
local PlayerList_Button = PlayerList:WaitForChild("Frame"):WaitForChild("ButtonBar")
local PlayerList_Button_Party = PlayerList_Button:WaitForChild("Party"):WaitForChild("TextButton")
local PlayerList_Button_Guild = PlayerList_Button:WaitForChild("Guild"):WaitForChild("TextButton")
local PlayerList_Button_ServerList = PlayerList_Button:WaitForChild("Server"):WaitForChild("TextButton")
local PlayerList_Button_Close = PlayerList_Button:WaitForChild("Close"):WaitForChild("TextButton")
local PlayerList_Party = PlayerList:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Party")
local PlayerList_Party_List = PlayerList_Party:WaitForChild("PartyList")
local PlayerList_Party_Create = PlayerList_Party:WaitForChild("NewParty")
local PlayerList_Party_Create_Create = PlayerList_Party_Create:WaitForChild("Create"):WaitForChild("TextButton")
local PlayerList_Party_Create_Buff = PlayerList_Party_Create:WaitForChild("Buff"):WaitForChild("Buff"):WaitForChild("TextButton")
local PlayerList_Party_Create_Type = PlayerList_Party_Create:WaitForChild("Type"):WaitForChild("Type"):WaitForChild("TextButton")
local PlayerList_Party_Create_SizeText = PlayerList_Party_Create:WaitForChild("Size"):WaitForChild("Size")
local PlayerList_Party_Create_SizePlus = PlayerList_Party_Create:WaitForChild("Size"):WaitForChild("+"):WaitForChild("TextButton")
local PlayerList_Party_Create_SizeMinus = PlayerList_Party_Create:WaitForChild("Size"):WaitForChild("-"):WaitForChild("TextButton")
local PlayerList_Party_MyParty = PlayerList_Party:WaitForChild("MyParty")
local PlayerList_Party_MyParty_Leave = PlayerList_Party_MyParty:WaitForChild("Leave"):WaitForChild("TextButton")
local PlayerList_Party_CreateButton = PlayerList_Party:WaitForChild("ButtonBar"):WaitForChild("CreateParty"):WaitForChild("TextButton")
local PlayerList_Party_ListButton = PlayerList_Party:WaitForChild("ButtonBar"):WaitForChild("PartyList"):WaitForChild("TextButton")
local PlayerList_Guild = PlayerList:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Guild")
local PlayerList_Server = PlayerList:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Server")
...
-->>StatsFrame
--Profession
local ProfessionList = StatsFrame:WaitForChild("ProfessionList")
local ProfessionDisplay = StatsFrame:WaitForChild("ProfessionDisplay")

--Combat
local CombatList = StatsFrame:WaitForChild("CombatList")
local CombatDisplay = StatsFrame:WaitForChild("CombatDisplay")
local CombatBack = CombatDisplay:WaitForChild("Back"):WaitForChild("TextButton")
local IsCombatOn = false
--Class
local ClassList = StatsFrame:WaitForChild("ClassList")
local ClassListList = StatsFrame:WaitForChild("ClassList"):WaitForChild("Classes"):WaitForChild("ScrollingFrame")
local ClassDisplay = StatsFrame:WaitForChild("ClassDisplay")
--Spell
local SpellList = StatsFrame:WaitForChild("SpellList")
local SpellDisplay = StatsFrame:WaitForChild("SpellDisplay")
--Statbuttons
local StatsFrame_Profession = StatsFrame:WaitForChild("ButtonFrame"):WaitForChild("ButtonFrame"):WaitForChild("Profession"):WaitForChild("TextButton")
local StatsFrame_Class = StatsFrame:WaitForChild("ButtonFrame"):WaitForChild("ButtonFrame"):WaitForChild("Class"):WaitForChild("TextButton")
local StatsFrame_Spell = StatsFrame:WaitForChild("ButtonFrame"):WaitForChild("ButtonFrame"):WaitForChild("Spell"):WaitForChild("TextButton")
local StatsFrame_Close = StatsFrame:WaitForChild("ButtonFrame"):WaitForChild("ButtonFrame"):WaitForChild("Close"):WaitForChild("TextButton")
--Settings
local Settings_Keybinds_Button = Settings:WaitForChild("Frame"):WaitForChild("ButtonBar"):WaitForChild("Keybinds"):WaitForChild("TextButton")
local Settings_Gameplay_Button = Settings:WaitForChild("Frame"):WaitForChild("ButtonBar"):WaitForChild("Gameplay"):WaitForChild("TextButton")
local Settings_Misc_Button = Settings:WaitForChild("Frame"):WaitForChild("ButtonBar"):WaitForChild("Misc"):WaitForChild("TextButton")
local Settings_Close_Button = Settings:WaitForChild("Frame"):WaitForChild("ButtonBar"):WaitForChild("Close"):WaitForChild("TextButton")
local Settings_Keybinds_Frame = Settings:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Keybinds")
local Settings_Gameplay_Frame = Settings:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Gameplay")
local Settings_Misc_Frame = Settings:WaitForChild("Frame"):WaitForChild("HolderFrame"):WaitForChild("Misc")
--Main Button
local Buttons_Inventory = Buttons:WaitForChild("Inventory")
local Buttons_Stats = Buttons:WaitForChild("Stats")
local Buttons_Players = Buttons:WaitForChild("Players")
local Buttons_Settings = Buttons:WaitForChild("Settings")
--ServerNotify
local ServerNotifyButton = ServerNotify:WaitForChild("ButtonFrame")
local ServerNotifyMessageType = ServerNotifyButton:WaitForChild("MessageType")
local ServerNotifyMessage = ServerNotifyButton:WaitForChild("Message")
	...
	if OnInteract.Visible and IsOnInteract == true and Item ~= nil then
		...
		if ServerItemData.ItemType == 1 then
			if IsEquippedInv then
				...
				OnInteract_Frame.Buttons.Equip.Text = string.format(OnInteract_Frame.Buttons.Equip.Text,"Weapon")
...
local function CreateDropEffect(Type,DataTable) -- 1. Item, 2. Material/Consumable, 3. LevelUp 4.Exp
	...
	if Type == 1 then
		...
		NewItem:TweenSize(UDim2.new(0, 0, 0.143, 0),Enum.EasingDirection.In,Enum.EasingStyle.Back,0.6-RarityMod/2,true)
		SoundPlaying(Sound)
	elseif Type == 3 then
