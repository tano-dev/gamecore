return {
	-- General
	Type = "Tool",
	Tip = "Sharper than bronze",
	
	Level = 3,
	IconId = 12894186866, -- Leave as 'nil' for no icon (show text)
	...
	-- Weapon
	WeaponType = "Melee",
	Damage = {2, 3}, -- Can be a table ({Min Damage, Max Damage}) or a number (Damage)
	...
	DefensePenetration = {0.7, false}, -- The amount of defense does the weapon ignores from mobs w/ defense (compatible to both % and damage point defenses)
