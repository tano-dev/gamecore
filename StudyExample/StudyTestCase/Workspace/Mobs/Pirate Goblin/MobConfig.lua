return {
	-- General
	Name = "Pirate Goblin", -- Name of the mob shown in its interface
	Rank = nil, -- Mob Rank - 'nil' for no rank, or a string for a rank ("Boss")
	
	Level = {1, 1}, -- Mob Level, followed by Min Level (req to kill/access the mob - this is typically the realm level / boss portal level)
	...
	Defense = {1, true}, -- The amount of damage the mob resists from hits
	...
	WalkSpeed = 13, -- How fast the mob is (studs per second)
	...
	-- Projectile
	Projectile = "Arrow", -- Name of projectile in RS --> Assets --> Projectiles
	
	Cooldown = 1.33, -- Time until projectile can be shot again
	ActivateSound = 16211041, -- Sound that plays when projectile is shot (can use strings)
